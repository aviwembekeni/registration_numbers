describe('AddRegNum', function() {
    ...
    it('should return registration numbers from Belville.', function() {
      var addRegNum = AddRegNum();
    ...
    it('should return registration numbers from Strand.', function() {
      var addRegNum = AddRegNum();
    ...
    it('should return all registration numbers when filter value is all.', function() {
      var addRegNum = AddRegNum();
